...
<template>
    <div class="wb">
        ...
        <h3>
            ...
            <router-link to="/page2">Forword</router-link>
        </h3>
    </div>
</template>
  ...
  methods: {
    search: function() {
      ...
      for (var i = 0; i < this.products.length; i++) {
        if (
          this.products[i].name.indexOf(this.values) != -1 ||
          this.products[i].price.indexOf(this.values) != -1 ||
          this.products[i].category.indexOf(this.values) != -1
        )
